...
cp ../../.env config/includes.chroot_after_packages/etc/skel/SIR-Lightboard-main
cp ../../token.pkl config/includes.chroot_after_packages/etc/skel/SIR-Lightboard-main
cp ../../client_secret.json config/includes.chroot_after_packages/etc/skel/SIR-Lightboard-main
